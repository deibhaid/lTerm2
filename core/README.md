...
- Byte-stream and parser-context abstractions (`lterm_reader.h/.c`, `lterm_parser_context.h`) that replace `VT100ByteStream`/`TerminalParserContext` with portable equivalents.
